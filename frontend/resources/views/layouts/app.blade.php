...
<body class="font-sans antialiased bg-gray-100">
    <div class="min-h-screen">
                    ...
                    <div class="flex">
                        ...
                        <div class="shrink-0 flex items-center">
                            <a href="{{ url('/') }}" class="text-xl font-semibold text-gray-800">
                                {{ config('app.name', 'Ai Chatbot Builder') }}
                            </a>
                        </div>
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            @auth
                                ...
                                <a href="{{ route('admin.handoffs') }}" class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                                    Handoffs
                                </a>
            ...
            <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    @auth
                        ...
                        <a href="{{ route('admin.handoffs') }}" class="block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:text-gray-800 focus:bg-gray-50 focus:border-gray-300 transition duration-150 ease-in-out">
                            Handoffs
                        </a>
                        @endif
                    @endauth
        ...
        <!-- Page Content -->
        <main>
            {{ $slot ?? '' }} {{-- This slot is for main content --}}
            @yield('content') {{-- Laravel 8+ style, or use $slot --}}
        </main>
    </div>
</body>
</html>
